...
- Documentation only — no code changes. The packaged README was refreshed to
  match 1.2.0: removed mentions of the DI tokens deleted from the public API,
  and documented the `visibility.fn` semantics (`true` = visible) and
  `clearOnHide` behavior.
